...
> {
  ...
  public readonly room: BelongsToAccessor<Room, typeof Reservation.prototype.id>;

  public readonly renter: BelongsToAccessor<User, typeof Reservation.prototype.id>;

  constructor(
    @inject('datasources.mongodb') dataSource: MongodbDataSource, @repository.getter('RoomRepository') protected roomRepositoryGetter: Getter<RoomRepository>, @repository.getter('UserRepository') protected userRepositoryGetter: Getter<UserRepository>,
  ) {
